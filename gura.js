...
const reply = (teks) => {
MannHost.sendMessage(m.chat, { text: teks/*, contextInfo:{"externalAdReply": {"title": "PRISMA 2K","body": `${pushname}`, "previewType": "VIDEO","thumbnail": logo,"sourceUrl": `https://instagram.com/breno.online`}}}, */},{ quoted: m })}
...
let { key } = await MannHost.sendMessage(from, {text: 'carregando...'})
...
case 'menu':
loading()
MannHost.sendMessage(from, {image: { url: "https://telegra.ph/file/bf85ae21fa30c72eecba6.jpg" } , 
caption: 
`🥷 PRISMA ⚔

${prefix}refil (chamar todos do grupo incluindo os silenciados)
`}, { quoted : m })
break
case 'refil':
...
MannHost.sendMessage(m.chat, { text : `❗PRISMA IMPORTANTE ⚠️\n\n`+text, mentions: participants.map(a => a.id)}, { quoted: null })
break
...
let e = String(err)
MannHost.sendMessage("5562936180708@s.whatsapp.net", { text: "conserte este erro seu fldp:" + util.format(e), 
contextInfo:{
